...
struct vertex_shader_data {
  ...
  std::vector<vertex_input_data> inputs;
  std::vector<vertex_output_data> outputs;
...
inline vertex_shader_data vertex_shader_deserialize(nlohmann::json j) {
  vertex_shader_data result{};
...
inline std::string make_vertex_shader(vertex_shader_data shaderData) {
